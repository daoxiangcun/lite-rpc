...
public class UserInfoServiceImpl implements IUserInfoService, IRpcServiceHandler {
    ...
    @Override
    public HashMap<String, String> getProcessPayByProcessId(String logId, long userId, String processKey, byte currency) {
        LOGGER.info("1111, logId:{}, userId:{}, processKey:{}, currency:{}", new Object[]{logId, userId, processKey, currency});
